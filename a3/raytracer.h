...
public:
	...
	void setHazeCoefficient(float haze) { m_Haze_Coefficient = haze; }
	float getHaze(float dist) { return exp((-1)*pow(dist*m_Haze_Coefficient, 2)); }
	Color getHazeColor() { return m_Haze_Color; }
	void setHazeColor(Color a_color) { m_Haze_Color = a_color; }
protected:
	// renderer data
